...
//Rout de Datos
Route::get('Mis-Datos', [StartController::class, 'DatosCreate']);
Route::put('Mis-Datos', [StartController::class, 'DatosUpdate']);
Route::get('Inicio-Editar', [StartController:: class, 'edit']);
Route::put('Inicio-Editar', [StartController:: class, 'update']);
